...
import MuliselectFilter from "./MuliselectFilter";
    ...
    return (
        <header className="flex shadow-sm bg-white font-[sans-serif] min-h-[70px]">
            <div className="flex flex-wrap items-center justify-between sm:px-10 px-6 py-3 relative lg:gap-y-4 gap-y-6 gap-x-4 w-full">
                ...
                <div className="bg-gray-100 flex border-2 rounded max-md:order-1 border-transparent focus-within:border-blue-500 focus-within:bg-transparent px-4 rounded-sm h-11 lg:w-1/4 max-md:w-full">
                ...
                {/* Filter html start */}
                <div className="relative w-48 md:w-52 flex items-center space-x-8 max-md:ml-auto">
                    Filter: <MuliselectFilter />
                </div>
                {/* select html start */}
                ...
                <div className="flex items-center space-x-8 max-md:ml-auto">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" className="cursor-pointer fill-[#333] hover:fill-[#077bff]" viewBox="0 0 512 512">
                        <path
            ...
            <div id="collapseMenu" className="hidden before:fixed before:bg-black before:opacity-40 before:inset-0 max-lg:before:z-50">
                <button id="toggleClose" className="fixed top-2 right-4 z-[100] rounded-full bg-white p-3">
                ...
                <ul className="block space-x-4 space-y-3 fixed bg-white w-1/2 min-w-[300px] top-0 left-0 p-4 h-full shadow-md overflow-auto z-50">
                    ...
                    <li className="border-b py-3 px-3">
                        <a href="javascript:void(0)" className="hover:text-[#007bff] text-[#007bff] block font-semibold text-base">
                            Home
                        </a>
                    </li>
                    <li className="border-b py-3 px-3">
                        <a href="javascript:void(0)" className="hover:text-[#007bff] text-black block font-semibold text-base">
                            Team
                        </a>
                    </li>
                    <li className="border-b py-3 px-3">
